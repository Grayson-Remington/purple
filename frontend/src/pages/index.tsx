      ...
      {rules && (
        <div className='fixed h-full w-full flex flex-col items-center z-50'>
          ...
          <div className='relative h-full overflow-y-scroll max-w-xl pb-20 mx-auto p-6 rounded-lg shadow-md'>
            ...
            <h1 className='text-2xl font-semibold mb-4'>Purple Instructions</h1>
            <span className='font-bold'>Aces</span>
            <ol className='list-disc pl-5 space-y-2'>
              <li className='mb-2'>Aces are high.</li>
            </ol>
            ...
            <ol className='list-disc pl-5 space-y-2'>
              <li className='mb-2'>
                Guessing Higher or Lower draws ONE card and compares it to the
                current card. If you get it right, the card goes in the Death
                Stack.
              </li>
              <li className='mb-2'>
                Guessing Purple draws TWO cards and compares the two suits. Red
                and blue need to combine to make purple. If you get it right,
                both cards goes in the Death Stack.
              </li>
            </ol>
            <span className='font-bold'>Passing</span>
            <ol className='list-disc pl-5 space-y-2'>
              <li className='mb-2'>
                Add 3 cards to the Death Stack in a row and earn the ability to
                pass to the Death Stack to the next player.
              </li>
              <li className='mb-2'>
                Passing the Death Stack earns you points equal to the amount of
                cards you added to the Death Stack.
              </li>
            </ol>
            ...
            <ol className='list-disc pl-5 space-y-2'>
              ...
              <li className='mb-2'>
                When you get one wrong, you lose points equal to the Death Stack
                AND the cards you were dealt.
              </li>
            </ol>
            <span className='font-bold'>Getting it Wrong</span>
            <ol className='list-disc pl-5 space-y-2'>
              <li className='mb-2'>Getting it wrong shuffles the deck.</li>
              <li className='mb-2'>
                When you get one wrong, you lose points equal to the death stack
                AND the cards you were dealt.
              </li>
            ...
            <ol className='list-disc pl-5 space-y-2'>
              <li className='mb-2'>
                When you get one right, you add points to the Death Stack and
                Turn Score equal to the amount of cards you were dealt. Higher
                or Lower = 1 point, Purple = 2 points
              </li>
              <li className='mb-2'>
                Add 3 cards to the Death Stack in a row and earn the ability to
                pass to the death stack to the next player.
      ...
      {!connectedToRoom ? (
        <div className='max-w-3xl flex flex-col gap-2 uppercase font-bold  items-center p-4'>
          <div className='flex items-center'>
            <img src='./blob.svg' className='h-20' alt='' />
          ...
          <div className='items-center text-center'>
            ...
            />
            {tooManyPlayers && <h1 className='text-red-800'>Room is Full</h1>}
          </div>
          <div className='items-center text-center'>
            <h1>Username</h1>
            <input
            ...
            {usernameAlreadyExists && (
              <h1 className='text-red-800'>Username Already exists</h1>
            )}
          </div>
          <div className='text-center mt-1 max-w-xs text-sm'>
            If left blank, a random room and username will be created for you
          </div>
          <button
              ...
              {players.map((player: any, index: number) => (
                <div
                  ...
                  className={`flex flex-col items-center ${
                    player.name == turn ? "bg-purple-400" : ""
                  } justify-center ${
                    player.score < -10 ? "text-red-600 animate-scale" : ""
                  } ${player.name == turn ? "font-extrabold" : ""}`}>
          ...
          <div
            ...
            <svg
              ...
              <motion.line
                ...
                ref={scope4}
              />
              <foreignObject x='110' y='140' z='20' width='20' height='20'>
                <motion.div ref={scope5} className='swirling-div2'>
                  <motion.div ref={scope6} className='red'></motion.div>
                  <motion.div ref={scope7} className='blue'></motion.div>
                </motion.div>
              </foreignObject>
            </svg>
            <img
            ...
            <div
              ...
              className={`absolute block ${animationNextCard} ${
                !(animationNextCard == "undefined") ? "z-20" : ""
              }`}>
              {isFlipped ? (
                <img
            ...
            <div
              ...
              className={`absolute block ${animationThirdCard} ${
                !(animationThirdCard == "undefined") ? "z-30" : ""
              }`}>
              {isFlipped ? (
                <img
                  className='w-[90px] h-[128.06px]'
            ...
            <div
              ...
              className={`block ${animationShownCard} ${
                !(animationShownCard == "undefined") ? "z-20" : ""
              }  `}>
              {isShownFlipped ? (
                <img
                  className='w-[90px] h-[128.06px]'
